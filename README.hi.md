...
- **इस प्रोजेक्ट को अभी उपलब्ध नहीं:** NIC e-invoice API विनिर्देश (प्रमाणीकरण, generate-IRN,
  cancel-IRN, signed-QR सामग्री), और मास्टर कोड सूचियाँ (राज्य कोड, HSN, UQC, मुद्रा, पोर्ट कोड)।
