...
| Notification No. 10/2023-Central Tax — companion notification imposing the 30-day IRP-upload limit for AATO ≥ ₹10 Cr | `[NEED:]` | Notification No. 10/2023-CT (now staged) addresses only the ₹5 Cr threshold substitution; it does not contain the 30-day upload-limit rule. That rule is a separate notification, not yet identified/supplied. Must not appear in this package's client-facing docs (README, tool docstrings) until the correct notification is staged and confirmed. |
